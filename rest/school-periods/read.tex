...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:schools-periods:read:ret}. 
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:schools-periods:read:ret:json} beschrieben.
\input{json}
