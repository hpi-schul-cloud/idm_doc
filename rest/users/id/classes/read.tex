...
start & DATE & Ein Datumsangabe nach ISO-8601 im Format YYYY-MM-DD. Zeitpunkt, ab dem das Klassenobjekt existiert, falls dies abweichend zum Startzeitpunkt des Schuljahres ist. \\ \hline 
end & DATE & Ein Datumsangabe nach ISO-8601 im Format YYYY-MM-DD. Zeitpunkt, bis zu dem das Klassenobjekt existiert, falls dies abweichend zum Endzeitpunkt des Schuljahres ist. \\ \hline 
\end{longtable}
