...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:users:id:memberships:read:ret}. 
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:users:id:memberships:read:ret} beschrieben.
Die Berechtigungen auf den Endpunkt können \reftabllec{tab:rest:api:users:id:memberships:read:right} entnommen werden.
\input{json}
