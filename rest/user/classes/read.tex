...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:user:classes:read:ret}. 
Die einzelnen Felder der Antwort werden in Tabelle \reftabllec{tab:rest:api:user:classes:read:ret} beschrieben.
