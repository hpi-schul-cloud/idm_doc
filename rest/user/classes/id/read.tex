...
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:user:classes:id:read:ret} beschrieben.
Die Berechtigungen auf den Endpunkt können \reftabllec{tab:rest:api:user:classes:id:read:right} entnommen werden.
\input{json}
