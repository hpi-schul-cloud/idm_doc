...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:user:subjects:id:read:ret}. 
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:user:subjects:id:read:ret} beschrieben.
