...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:user:subjects:id:read:ret}. Die einzelnen Felder der Antwort werden in Tabelle \reftabllec{tab:rest:api:user:subjects:id:read:ret} beschrieben.
Die Berechtigungen auf den Endpoint können \reftabllec{tab:rest:api:user:subjects:id:read:right} entnommen werden.
\input{json}
