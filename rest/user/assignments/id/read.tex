...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:user:assignments:id:read:ret}. 
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:user:assignments:id:read:ret} beschrieben.
Die Berechtigungen auf den Endpunkt können \reftabllec{tab:rest:api:user:assignments:id:read:right} entnommen werden.
\input{json}
