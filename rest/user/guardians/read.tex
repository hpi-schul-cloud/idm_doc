...
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:user:guardians:read:ret} beschrieben.
Die Berechtigungen auf den Endpunkt können \reftabllec{tab:rest:api:user:guardians:read:right} entnommen werden.
\input{json}
