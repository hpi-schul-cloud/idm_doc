...
school & Object & Objekt mit Informationen zu Schule zu der die Klasse gehört. Der Aufbau des Objektes kann \reftabllec{tab:rest:api:classes:id:school} entnommen werden.  \\ \hline
schoolPeriod & Object & Objekt mit Informationen zum Schuljahr, in welchem der Benutzer die Klasse besucht hat. Der Aufbau des Objektes kann \reftabllec{tab:rest:api:classes:id:schoolperiod} entnommen werden. \\ \hline
...
\endfoot
        \caption{Beschreibung der Felder im JSON-Objekt für die Schule }
        \label{tab:rest:api:classes:id:school}
\endlastfoot 
\hline
            \textbf{Feldname} & \textbf{Datentyp} & \textbf{Beschreibung} \\ \hline
\endhead
...
\endfoot
        \caption{Beschreibung der Felder im JSON-Objekt für das Schuljahr }
        \label{tab:rest:api:classes:id:schoolperiod}
\endlastfoot 
\hline
            \textbf{Feldname} & \textbf{Datentyp} & \textbf{Beschreibung} \\ \hline
\endhead
