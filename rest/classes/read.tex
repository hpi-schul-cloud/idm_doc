...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:end:rest:api:reference-subjects:read:ret}. Die einzelnen Felder der Antwort werden in \reftabllec{tab:end:rest:api:reference-subjects:read:ret:json} beschrieben.
\input{json}
