...
\input{json}
\begin{lstlisting}[caption={JSON-Antwort für einen GET-Aufruf der Route /api/schools},label={lst:code:rest:api:school:read:ret},frame=tlrb]
[
 "<STRING>",
 ...
]
...
\begin{longtable}{|p{0.16\textwidth}|p{0.16\textwidth}|p{0.58\textwidth}|}
		\caption{Beschreibung des Felder in eine JSON-Objekt was die Schul-IDs wieder gibt}
\endfoot
		\caption{Beschreibung des Felder in eine JSON-Objekt was die Schul-IDs wieder gibt}
...
\endhead
 & STRING & Eindeutiger Identifikations String der Schule im IDM, womit unter /api/schools/\$id die Schule abgerufen werden kann.\\ \hline
\end{longtable}
...
\endfoot
		\caption{Berechtigungen auf dem Endpunkt}
		\label{tab:rest:api:school:read:right}
\endlastfoot
\hline
