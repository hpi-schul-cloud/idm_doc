...
Diese Route gib für die per ID ausgewählte Schule die Stammdaten zurück.
...
\input{json}
\begin{lstlisting}[caption={JSON-Antwort für einen GET-Aufruf der Route /api/school/\$id},label={lst:code:rest:api:school:id:read:ret},frame=tlrb]
{
 school: "<STRING>",
 name: "<STRING>",
}
