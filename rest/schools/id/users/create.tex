...
\input{json}
\begin{lstlisting}[caption={Felder im JSON-Object einer CREATE anfrage per HTTP-POST auf der Route /api/schools/\$id/users},label={lst:code:rest:api:schools:id:users:create:request},frame=tlrb]
{
 user_id: "<STRING>",
 role: "<STRING>",
 start: "<TIMESTAMP>"
