...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:school:users:id:read:ret}.
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:school:users:id:read:ret:json} beschrieben.
Die Berechtigungen auf den Endpunkt können aus \reftabllec{tab:rest:api:school:users:id:read:right} entnommen werden.
