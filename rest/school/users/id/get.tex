...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:school:users:id:get:ret}. Die einzelnen Felder der Antwort werden in Tabelle \reftabllec{tab:rest:api:school:users:id:get:ret:json} beschrieben.
Die Berechtigungungen auf den Endpoint können aus \reftabllec{tab:rest:api:school:users:id:get:right} entnommen werden.
