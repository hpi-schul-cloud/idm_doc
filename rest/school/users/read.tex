...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:end:rest:api:school:users:read:ret}. Die einzelnen Felder der Antwort werden in Tabelle \reftabllec{tab:end:rest:api:school:users:read:ret:json} beschrieben.
Die Berechtigungungen auf den Endpoint können aus \reftabllec{tab:end:rest:api:school:users:read:right} entnommen werden.
\input{json}
