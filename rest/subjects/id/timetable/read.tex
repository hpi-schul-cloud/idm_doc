...
repeat & ENUM & Mögliche Werte sind: \begin{itemize}
				...
				\end{itemize} \\ \hline
date & CALENDARDATE & Optional; wird gesetzt, falls es sich um den repeat-Typen "`onetime"' handelt, und gibt den Tag an, an dem die Unterrichtseinheit stattfindet. \\ \hline
