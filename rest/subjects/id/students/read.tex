...
Eine READ Anfrage auf diese Route gibt eine Liste mit Objekten welche Schüler von wann bis wann an den per ID ausgewählten Unterrichtsfaches teilgenommen hat wieder.
...
\endfoot
		\caption{Berechtigungen auf dem Endpunkt}
		\label{tab:rest:api:subjects:id:students:read:right}
\endlastfoot
\hline
