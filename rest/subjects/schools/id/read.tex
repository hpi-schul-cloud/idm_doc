...
Die einzelnen Felder der Antwort werden in \reftabllec{tab:rest:api:subjects:schools:id:read:ret:json} beschrieben.
Die Berechtigungen auf den Endpunkt können \reftabllec{tab:rest:api:subjects:schools:id:read:right} entnommen werden.
\input{json}
