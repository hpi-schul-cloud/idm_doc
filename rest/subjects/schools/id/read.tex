...
Die Antwort erfolgt mit dem JSON-Objekt \reflisting{lst:code:rest:api:subjects:schools:id:read:ret}. 
Die einzelnen Felder der Antwort werden in Tabelle \reftabllec{tab:rest:api:subjects:schools:id:read:ret:json} beschrieben.
Die Berechtigungen auf den Endpoint können \reftabllec{tab:rest:api:subjects:schools:id:read:right} entnommen werden.
\input{json}
