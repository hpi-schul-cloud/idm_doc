...
Die einzelnen Felder der Antwort werden in Tabelle \reftabllec{tab:rest:api:subjects:read:ret} beschrieben.
Die Berechtigungen auf den Endpoint können \reftabllec{tab:rest:api:subjects:read:right} entnommen werden.
\input{json}
