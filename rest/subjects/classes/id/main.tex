...
Die \reftabllec{tab:end:rest:api:subjects:classes:id:meth} listet auf, welche Operationen zugelassen sind und welche HTTP-Methoden dabei verwendet werden. 
...
\input{rest/subjects/classes/id/read}